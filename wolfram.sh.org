...
In this case, call ~tput cols~ to get the number of columns in the terminal window.
...
With the initial state, the ~draw()~ function prints a single box in the middle of the screen to represent a single living cell.
...
#+RESULTS[734f6e49985149b0174dc450e29f2ba63dc686ef]:
#+begin_example
░░░░░░░░░░░░░░░░░░░░█░░░░░░░░░░░░░░░░░░░░
#+end_example
...
The program includes command line options to aid with testing.

The ~-w~ option sets the ~width~ variable, which represents the width of the simulation for scenarios where the width can't be determined automatically, or when it's inconvenient to do so.

#+name: command-line-options-for-testing
#+begin_src bash
